...
class GrpcTeamMemberService {
  ...
  static Future<TeamMemberPageData> getTeamMemberPage({
    int? businessProfileId,
    int? personId,
  }) async {
    try {
      final response = await _ensureClient().getTeamMemberPage(
        $tm.TeamMemberPageRequest(
  ...
  static Future<TeamMember> sendTeamMemberRequest({
    required int businessProfileId,
    required int personId,
  }) async {
    try {
      ...
      throw BaseService.handleGrpcError(
        e,
        'Failed to send team member request',
      );
    }
  }

  static Future<TeamMember> acceptTeamMemberRequest({
    required int businessProfileId,
    required int personId,
  }) async {
    try {
      ...
      throw BaseService.handleGrpcError(
        e,
        'Failed to accept team member request',
      );
    }
  }

  static Future<TeamMember> denyTeamMemberRequest({
    required int businessProfileId,
    required int personId,
  }) async {
    try {
      ...
      throw BaseService.handleGrpcError(
        e,
        'Failed to deny team member request',
      );
    }
  }

  static Future<TeamMember> cancelTeamMemberRequest({
    required int businessProfileId,
    required int personId,
  }) async {
    try {
      ...
      throw BaseService.handleGrpcError(
        e,
        'Failed to cancel team member request',
      );
    }
  }
  ...
  static $tm.TeamMemberServiceClient _ensureClient() {
    ...
    _client = $tm.TeamMemberServiceClient(
      channel,
