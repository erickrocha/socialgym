...
import 'package:lapidation_mobile/services/grpc/grpc_exercise_service.dart';
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              AppLocalizations.of(
                context,
              )!.exerciseCreateSuccess(exercise.name),
            ),
