...
import 'package:lapidation_mobile/pages/notifications/notifications_page.dart';
          ...
          Positioned.fill(
            ...
            child: Navigator(
              onGenerateRoute: (_) => MaterialPageRoute<void>(
                builder: (_) =>
                    PendingConsentsPage(navigatorKey: widget.navigatorKey),
              ),
            ),
          ),
      ],
