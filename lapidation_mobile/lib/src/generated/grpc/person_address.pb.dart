...
class PersonAddress extends $pb.GeneratedMessage {
  factory PersonAddress({
    $core.int? id,
    $core.String? uuid,
    $core.int? personId,
  ...
  factory PersonAddress.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory PersonAddress.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PersonAddress',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'grpc.person_address'),
  ...
  PersonAddress clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  PersonAddress copyWith(void Function(PersonAddress) updates) =>
      super.copyWith((message) => updates(message as PersonAddress))
          as PersonAddress;
  ...
  static PersonAddress create() => PersonAddress._();
  @$core.override
  PersonAddress createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static PersonAddress getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PersonAddress>(create);
  static PersonAddress? _defaultInstance;
