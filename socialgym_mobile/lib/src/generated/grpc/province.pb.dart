...
class Province extends $pb.GeneratedMessage {
  ...
  factory Province.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Province.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  Province clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Province copyWith(void Function(Province) updates) =>
      super.copyWith((message) => updates(message as Province)) as Province;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static Province create() => Province._();
  @$core.override
  Province createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static Province getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Province>(create);
