...
class WorkoutMapper implements Mapper<domain.Workout, $workout.Workout> {
  ...
  domain.Workout fromProto($workout.Workout proto) {
    return domain.Workout(
      ...
      createdAt: proto.createdAt.isEmpty ? null : DateTime.parse(proto.createdAt),
      updatedAt: proto.updatedAt.isEmpty ? null : DateTime.parse(proto.updatedAt),
      ...
      assignedByProfileUuid:
          proto.assignedByProfileUuid.isEmpty ? null : proto.assignedByProfileUuid,
    );
  }
