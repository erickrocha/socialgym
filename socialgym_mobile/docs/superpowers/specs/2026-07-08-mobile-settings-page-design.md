...
Add a page in `socialgym_mobile` where the logged-in user can view and edit their
...
- `socialgym_mobile/proto/settings.proto` is already staged on this branch and
