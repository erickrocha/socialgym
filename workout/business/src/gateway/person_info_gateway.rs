...
use entity::person_info;
use entity::person_info::Model;
use entity::prelude::PersonInfo as PersonInfoQuery;
...
impl PersonInfoGateway {
    ...
    pub async fn update(db: &DbConn, entity: PersonInfo) -> Result<Model, DbErr> {
        let active_model = PersonInfoEntityMapper::build_active_model(entity);
